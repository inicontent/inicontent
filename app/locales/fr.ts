export default {
	fr: {
		...
		preset: "Préréglage",
		creationCronNotice:
			"Créez automatiquement des lignes selon une planification fixe à partir d'une charge utile JSON enregistrée.",
		...
		payloadHelp: "Utilisez un objet JSON normal pour la ligne à créer.",
