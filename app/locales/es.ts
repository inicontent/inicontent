export default {
	es: {
		...
		preset: "Preajuste",
		creationCronNotice:
			"Crea filas automáticamente con una programación fija usando una carga JSON guardada.",
		...
		payloadHelp: "Usa un objeto JSON normal para la fila que quieres crear.",
