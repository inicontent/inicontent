export default {
	es: {
		...
		copyFields: "Copiar campos",
		pasteFields: "Pegar campos del portapapeles",
		noFieldsInClipboard: "No hay campos en el portapapeles",
		noFieldsToCopy: "No hay campos para copiar",
		cutSuccessfully: "Cortado con éxito",
		...
		basicInformationDescription:
			"Define los detalles de la base de datos y el idioma predeterminado.",
		buildTables: "Construir tablas",
		buildTablesDescription:
			"Describe tus tablas y generaremos un esquema inicial.",
		tables: "Tablas",
		table: "Tabla",
		...
		enableRealtimeSync: "Habilitar sincronización en tiempo real de datos",
		realtimeEnabled: "Sincronización en tiempo real habilitada",
		connectingToRealtime: "Conectando a sincronización en tiempo real...",
		...
		fields: {
			...
			quarter: "Trimestre",
			quarterRange: "Rango de trimestres",
			week: "Semana",
			toggle: "Alternar",
			select: "Seleccionar",
		...
		payloadTemplate: "Plantilla de carga útil",
		...
		noWidgets: "Sin widgets aún. Añade uno para empezar.",
		widgetCount: {
			one: "{count} widget",
			other: "{count} widgets",
		},
		...
		// Offline / sync
		offlineReconnect: "Conexión restablecida. Sincroniza los cambios guardados.",
		offlineBlockedIntro: "Este cambio bloquea la sincronización. Edítalo y reintenta, o descártalo para continuar.",
		offlineDiscard: "Descartar cambio",
		offlineEditRetry: "Guardar y reintentar",
		offlineInvalidJson: "Introduce un objeto JSON válido.",
		offlineNoSearchColumns: "Esta tabla no tiene columnas de búsqueda. Introduce un ID o configura las columnas.",
		offlinePickManually: "Se encontraron varias coincidencias. Elige manualmente introduciendo el ID exacto.",
		offlineReferenceNotFound: "No se encontró ningún elemento. Introduce un ID o corrige el texto.",
		offlineInvalidReference: "No se pudo resolver la referencia.",
		offlineMissingDependency: "Falta un elemento sin conexión referenciado. Sustituye su ID temporal o descarta este cambio.",
		offlineDependencyCycle: "Las referencias sin conexión forman un ciclo. Edita las referencias.",
		offlineMissingCreatedId: "El servidor no devolvió el ID creado. Comprueba el servidor antes de reintentar.",
		offlineSyncFailed: "Error de sincronización. Revisa el cambio y reintenta.",
		online: "En línea",
		offline: "Sin conexión",
		onlineTooltip: "Conectado al servidor",
		offlineTooltip:
			"Sin conexión. Los cambios se guardan localmente. Pulsa Sincronizar cuando tengas conexión.",
		...
		conflictModalIntro:
			"Tu cambio sin conexión entra en conflicto con una versión más reciente en el servidor. Elige qué versión conservar.",
		...
		queuedOfflineToast:
			"Cambio guardado localmente. Pulsa Sincronizar cuando tengas conexión.",
