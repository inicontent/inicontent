export default {
    en: {
        ...
        apiDocs: {
            ...
            tableNotFoundDescription: "Double-check the slug or pick another table from the list.",
            ...
            auth: {
                ...
                passwordField: "password — plain text password that will be hashed on the server",
                signupDescription:
