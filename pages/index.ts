	...
	async setup() {
		...
		database.value = (
			await $fetch<apiResponse<Database>>(
				`${useRuntimeConfig().public.apiBase}inicontent/database/inicontent`
			)
		).result;
		useLanguage({
			ar: {
		...
		return () =>
			h(
              ...
              .banner {
                  ...
                  position: relative;
                  height: calc(100vh - 64px - 34px - 24px);
                  text-align: center;
                  display: flex;
            ...
            `,
										...
										h("g", { style: { opacity: 0.9 } }, [
											h("g", {}, [
												...
												h("path", {
													...
													style: {
														transition:
															"fill .3s var(--cubic-bezier-ease-in-out)",
											...
											h("circle", {
												...
												filter: "url(#filter-1)",
												transform:
													"translate(106.010000, 376.700000) scale(-1, 1) translate(-106.010000, -376.700000)",
												cx: "106.01",
												cy: "376.7",
												r: "20",
											}),
					...
					h("div", { style: { padding: "0 24px" } }, [
						h(
							...
							() =>
								h(NGrid, { xGap: 12, yGap: 12, cols: "1 500:2 800:5" }, () => [
									h(NGi),
									h(NGi),
									h(NGi, () =>
										h(
												...
												h(
													...
													() => [
														h(NTimeline, () => [
															...
															h(NTimelineItem, {
																title: "Unlimited Users & Roles",
															}),
															h(NTimelineItem, { title: "250 mb" }),
															h(NTimelineItem, { title: "Basic CDN" }),
														]),
														h(
															NGradientText,
															{
