...
────📁 layouts
    ...
    └───📄 defineTranslation.ts # Used for managing multi-lang and display text based on current selected lang (+ fetch from "translations" table the non predefined translations)
```
