import{b as x,d as p,e as g,ah as w,i as $,ab as y,l as m,ai as k,w as _,t as a,aE as N}from"./DtwXQcKw.js";import{i as R}from"./vGsHMXf5.js";const z=/^(\d|\.)+$/,v=/(\d|\.)+/;function S(e,{c:r=1,offset:i=0,attachPx:o=!0}={}){if(typeof e=="number"){const t=(e+i)*r;return t===0?"0":`${t}px`}else if(typeof e=="string")if(z.test(e)){const t=(Number(e)+i)*r;return o?t===0?"0":`${t}px`:`${t}`}else{const t=v.exec(e);return t?e.replace(v,String((Number(t[0])+i)*r)):e}return e}const P=x("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const V=(e,r,i,o)=>({color:t="currentColor",size:n,stroke:s,title:c,class:h,...l},{attrs:d,slots:f})=>{let u=[...o.map(C=>a(...C)),...f.default?[f.default()]:[]];return c&&(u=[a("title",c),...u]),a("svg",{...b[e],width:n,height:n,...d,class:["tabler-icon",`tabler-icon-${r}`],...e==="filled"?{fill:t}:{"stroke-width":s??b[e]["stroke-width"],stroke:t},...l},u)};export{O as N,V as c,S as f};
