import{i as q,A as z,aW as bt,t as l,ad as ct,j as ye,aD as ft,l as Y,as as pt,a3 as ut,am as vt,b as r,d as n,e as u,f as W,h as ht,a9 as gt,af as we,a2 as Z,ae as ee,N as mt,q as xt,ac as B,aN as yt,al as j,ag as wt,at as St,au as Ct,bp as Rt,ar as zt}from"./CFZop9RU.js";import{A as $t}from"./BN84AgVd.js";import{r as Tt}from"./DjWqVgbA.js";import{N as Pt}from"./C3mGUiDb.js";import{o as Wt}from"./DbnPTcif.js";import{t as _t}from"./DP7J1Wdj.js";import{u as ue}from"./TZclZtjG.js";import{f as te,u as At,V as ae}from"./D2GkMi_I.js";import{t as re}from"./Dzm2EfIM.js";import{c as Lt,a as ve,o as Bt}from"./-6wSLrES.js";import{g as U,r as he,c as G,d as jt}from"./Cjrk4TDS.js";const Et=ve(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ve("&::-webkit-scrollbar",{width:0,height:0})]),kt=q({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=z(null);function s(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const c=bt();return Et.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Lt,ssr:c}),Object.assign({selfRef:e,handleWheel:s},{scrollTo(...d){var x;(x=e.value)===null||x===void 0||x.scrollTo(...d)}})},render(){return l("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}}),se=ct("n-tabs"),Se={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Jt=q({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Se,setup(e){const s=ye(se,null);return s||ft("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:s.paneStyleRef,class:s.paneClassRef,mergedClsPrefix:s.mergedClsPrefixRef}},render(){return l("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Ht=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Wt(Se,["displayDirective"])),ne=q({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Ht,setup(e){const{mergedClsPrefixRef:s,valueRef:c,typeRef:y,closableRef:d,tabStyleRef:x,addTabStyleRef:v,tabClassRef:w,addTabClassRef:S,tabChangeIdRef:h,onBeforeLeaveRef:f,triggerRef:E,handleAdd:A,activateTab:g,handleClose:C}=ye(se);return{trigger:E,mergedClosable:Y(()=>{if(e.internalAddable)return!1;const{closable:m}=e;return m===void 0?d.value:m}),style:x,addStyle:v,tabClass:w,addTabClass:S,clsPrefix:s,value:c,type:y,handleClose(m){m.stopPropagation(),!e.disabled&&C(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){A();return}const{name:m}=e,T=++h.id;if(m!==c.value){const{value:L}=f;L?Promise.resolve(L(e.name,c.value)).then($=>{$&&h.id===T&&g(m)}):g(m)}}}},render(){const{internalAddable:e,clsPrefix:s,name:c,disabled:y,label:d,tab:x,value:v,mergedClosable:w,trigger:S,$slots:{default:h}}=this,f=d??x;return l("div",{class:`${s}-tabs-tab-wrapper`},this.internalLeftPadded?l("div",{class:`${s}-tabs-tab-pad`}):null,l("div",Object.assign({key:c,"data-name":c,"data-disabled":y?!0:void 0},pt({class:[`${s}-tabs-tab`,v===c&&`${s}-tabs-tab--active`,y&&`${s}-tabs-tab--disabled`,w&&`${s}-tabs-tab--closable`,e&&`${s}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:S==="click"?this.activateTab:void 0,onMouseenter:S==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),l("span",{class:`${s}-tabs-tab__label`},e?l(ut,null,l("div",{class:`${s}-tabs-tab__height-placeholder`}," "),l(vt,{clsPrefix:s},{default:()=>l($t,null)})):h?h():typeof f=="object"?f:Tt(f??c)),w&&this.type==="card"?l(Pt,{clsPrefix:s,class:`${s}-tabs-tab__close`,onClick:this.handleClose,disabled:y}):null))}}),Ot=r("tabs",`
