import{i as K,A as z,aQ as bt,t as l,ad as ct,j as ye,aq as ft,l as q,ax as pt,a3 as ut,ah as vt,b as r,d as n,e as u,f as W,h as ht,a9 as gt,af as we,a2 as Z,ae as ee,N as mt,q as xt,ac as B,aC as yt,aK as j,ag as wt,bk as St,aL as Ct,aV as Rt,aM as zt}from"./GicmGKj6.js";import{A as $t}from"./DCkyFCl3.js";import{r as Tt}from"./CdrcvSxE.js";import{N as Pt}from"./DTu6_oKm.js";import{o as Wt}from"./DbnPTcif.js";import{t as _t}from"./CIaL31g3.js";import{u as ue}from"./DiPEGMYL.js";import{f as te,V as ae}from"./CU2JJRiU.js";import{u as Lt}from"./BLWkGjX4.js";import{t as re}from"./CIe6CzKt.js";import{c as At,a as ve,o as Bt}from"./BZk9bI-9.js";import{g as U,a as he,c as G,d as jt}from"./B5x2ntQ_.js";const Et=ve(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ve("&::-webkit-scrollbar",{width:0,height:0})]),kt=K({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=z(null);function i(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const c=bt();return Et.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:At,ssr:c}),Object.assign({selfRef:e,handleWheel:i},{scrollTo(...d){var x;(x=e.value)===null||x===void 0||x.scrollTo(...d)}})},render(){return l("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}}),ie=ct("n-tabs"),Se={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Qt=K({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Se,setup(e){const i=ye(ie,null);return i||ft("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:i.paneStyleRef,class:i.paneClassRef,mergedClsPrefix:i.mergedClsPrefixRef}},render(){return l("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Ht=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Wt(Se,["displayDirective"])),ne=K({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Ht,setup(e){const{mergedClsPrefixRef:i,valueRef:c,typeRef:y,closableRef:d,tabStyleRef:x,addTabStyleRef:v,tabClassRef:w,addTabClassRef:S,tabChangeIdRef:h,onBeforeLeaveRef:f,triggerRef:E,handleAdd:L,activateTab:g,handleClose:C}=ye(ie);return{trigger:E,mergedClosable:q(()=>{if(e.internalAddable)return!1;const{closable:m}=e;return m===void 0?d.value:m}),style:x,addStyle:v,tabClass:w,addTabClass:S,clsPrefix:i,value:c,type:y,handleClose(m){m.stopPropagation(),!e.disabled&&C(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){L();return}const{name:m}=e,T=++h.id;if(m!==c.value){const{value:A}=f;A?Promise.resolve(A(e.name,c.value)).then($=>{$&&h.id===T&&g(m)}):g(m)}}}},render(){const{internalAddable:e,clsPrefix:i,name:c,disabled:y,label:d,tab:x,value:v,mergedClosable:w,trigger:S,$slots:{default:h}}=this,f=d??x;return l("div",{class:`${i}-tabs-tab-wrapper`},this.internalLeftPadded?l("div",{class:`${i}-tabs-tab-pad`}):null,l("div",Object.assign({key:c,"data-name":c,"data-disabled":y?!0:void 0},pt({class:[`${i}-tabs-tab`,v===c&&`${i}-tabs-tab--active`,y&&`${i}-tabs-tab--disabled`,w&&`${i}-tabs-tab--closable`,e&&`${i}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:S==="click"?this.activateTab:void 0,onMouseenter:S==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),l("span",{class:`${i}-tabs-tab__label`},e?l(ut,null,l("div",{class:`${i}-tabs-tab__height-placeholder`}," "),l(vt,{clsPrefix:i},{default:()=>l($t,null)})):h?h():typeof f=="object"?f:Tt(f??c)),w&&this.type==="card"?l(Pt,{clsPrefix:i,class:`${i}-tabs-tab__close`,onClick:this.handleClose,disabled:y}):null))}}),Ot=r("tabs",`
