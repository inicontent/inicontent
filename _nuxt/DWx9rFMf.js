import{ah as q,r as z,cM as bt,j as l,cd as ct,aC as we,cQ as ft,a6 as Y,aO as pt,O as ut,c0 as r,c9 as n,b$ as u,cb as W,ca as vt,c1 as ht,c2 as Se,dR as gt,z as ee,aP as te,k as mt,b2 as xt,bs as B,bN as yt,ci as j,bS as wt,bK as St,X as Ct,a4 as Rt}from"./DJ3poR1r.js";import{N as zt,u as $t,r as ve,c as G}from"./Dari_zsp.js";import{A as Tt}from"./BytqVAUH.js";import{r as Pt}from"./Dx48Db3i.js";import{N as Wt,g as K,d as _t}from"./BrWYrq9v.js";import{o as Lt}from"./DbnPTcif.js";import{u as he}from"./rSNn_jNv.js";import{c as ae,u as At,V as re}from"./BwKcinET.js";import{t as oe}from"./uZ_Bk_q8.js";import{c as Bt,a as ge,o as jt}from"./VNDdbXU3.js";const Et=ge(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ge("&::-webkit-scrollbar",{width:0,height:0})]),kt=q({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=z(null);function s(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const c=bt();return Et.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Bt,ssr:c}),Object.assign({selfRef:e,handleWheel:s},{scrollTo(...d){var x;(x=e.value)===null||x===void 0||x.scrollTo(...d)}})},render(){return l("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}}),ie=ct("n-tabs"),Ce={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},qt=q({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Ce,setup(e){const s=we(ie,null);return s||ft("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:s.paneStyleRef,class:s.paneClassRef,mergedClsPrefix:s.mergedClsPrefixRef}},render(){return l("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Ht=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Lt(Ce,["displayDirective"])),se=q({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Ht,setup(e){const{mergedClsPrefixRef:s,valueRef:c,typeRef:y,closableRef:d,tabStyleRef:x,addTabStyleRef:v,tabClassRef:w,addTabClassRef:S,tabChangeIdRef:h,onBeforeLeaveRef:f,triggerRef:k,handleAdd:_,activateTab:g,handleClose:C}=we(ie);return{trigger:k,mergedClosable:Y(()=>{if(e.internalAddable)return!1;const{closable:m}=e;return m===void 0?d.value:m}),style:x,addStyle:v,tabClass:w,addTabClass:S,clsPrefix:s,value:c,type:y,handleClose(m){m.stopPropagation(),!e.disabled&&C(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){_();return}const{name:m}=e,T=++h.id;if(m!==c.value){const{value:L}=f;L?Promise.resolve(L(e.name,c.value)).then($=>{$&&h.id===T&&g(m)}):g(m)}}}},render(){const{internalAddable:e,clsPrefix:s,name:c,disabled:y,label:d,tab:x,value:v,mergedClosable:w,trigger:S,$slots:{default:h}}=this,f=d??x;return l("div",{class:`${s}-tabs-tab-wrapper`},this.internalLeftPadded?l("div",{class:`${s}-tabs-tab-pad`}):null,l("div",Object.assign({key:c,"data-name":c,"data-disabled":y?!0:void 0},pt({class:[`${s}-tabs-tab`,v===c&&`${s}-tabs-tab--active`,y&&`${s}-tabs-tab--disabled`,w&&`${s}-tabs-tab--closable`,e&&`${s}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:S==="click"?this.activateTab:void 0,onMouseenter:S==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),l("span",{class:`${s}-tabs-tab__label`},e?l(ut,null,l("div",{class:`${s}-tabs-tab__height-placeholder`}," "),l(zt,{clsPrefix:s},{default:()=>l(Tt,null)})):h?h():typeof f=="object"?f:Pt(f??c)),w&&this.type==="card"?l(Wt,{clsPrefix:s,class:`${s}-tabs-tab__close`,onClick:this.handleClose,disabled:y}):null))}}),Ot=r("tabs",`
